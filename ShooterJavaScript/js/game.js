...
to = {
    'bool': function (obj, def) {
        if (is.valid(obj))
            return ((obj == 1) || (obj == true) || (obj == "1") || (obj == "y") || (obj == "Y") || (obj.toString().toLowerCase() == "true") || (obj.toString().toLowerCase() == 'yes'));
        else
            return (is.bool(def) ? def : false);
    },
    ...
    'array': function (obj, def) {
        if (is.array(obj))
            return obj;
        return is.valid(obj) ? [obj] : (def || []);
    }
}
...
ObjectPool.prototype = {
    ...
    initialize: function (klass, options) {
        ...
        if (options.delegators) {
            ...
            klass.prototype.isAllocated = function () {
                return klass.pool.isAllocated(this);
            };
            klass.prototype.isFree = function () {
                return klass.pool.isFree(this);
            };
            klass.prototype.free = function () {
                klass.pool.free(this);
            };
        }
    ...
    isAllocated: function (obj) {
        return obj.pindex < this.next;
    },
    isFree: function (obj) {
        return obj.pindex >= this.next;
    },
    ...
    remaining: function () {
        return this.store.length - this.next
    },
    length: function () {
