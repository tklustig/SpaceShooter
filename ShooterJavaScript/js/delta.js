Delta = function () {
    ...
    var cfg = {
        ...
        keys: [
            {key: Game.Key.SPACE, mode: 'up', state: 'title', action: function () {
                    engine.start();
                }},
            {key: Game.Key.ESC, mode: 'up', state: 'playing', action: function () {
                    engine.quit();
                }},
            {key: [Game.Key.UP, Game.Key.W], mode: 'down', state: ['preparing', 'playing'], action: function () {
                    player.movingUp = true;
                }},
            {key: [Game.Key.UP, Game.Key.W], mode: 'up', state: ['preparing', 'playing'], action: function () {
                    player.movingUp = false;
                }},
            {key: [Game.Key.DOWN, Game.Key.S], mode: 'down', state: ['preparing', 'playing'], action: function () {
                    player.movingDown = true;
                }},
            {key: [Game.Key.DOWN, Game.Key.S], mode: 'up', state: ['preparing', 'playing'], action: function () {
                    player.movingDown = false;
                }},
            {key: [Game.Key.LEFT, Game.Key.A], mode: 'down', state: ['preparing', 'playing'], action: function () {
                    player.movingLeft = true;
                }},
            {key: [Game.Key.LEFT, Game.Key.A], mode: 'up', state: ['preparing', 'playing'], action: function () {
                    player.movingLeft = false;
                }},
            {key: [Game.Key.RIGHT, Game.Key.D], mode: 'down', state: ['preparing', 'playing'], action: function () {
                    player.movingRight = true;
                }},
            {key: [Game.Key.RIGHT, Game.Key.D], mode: 'up', state: ['preparing', 'playing'], action: function () {
                    player.movingRight = false;
                }},
            {key: [Game.Key.SPACE, Game.Key.RETURN], mode: 'down', state: ['preparing', 'playing'], action: function () {
                    player.firing = true;
                }},
            {key: [Game.Key.SPACE, Game.Key.RETURN], mode: 'up', state: ['preparing', 'playing'], action: function () {
                    player.firing = false;
                }}
        ],
    ...
    var Engine = Class.create({
        ...
        isBooting: function () {
            return this.is('booting') || this.is('none');
        },
        isTitle: function () {
            return this.is('title');
        },
        isPreparing: function () {
            return this.is('preparing');
        },
        isPlaying: function () {
        ...
        onenterbooting: function () {
            $('booting').show();
        },
        onleavebooting: function () {
            $('booting').hide();
        },
        ...
        onenterpreparing: function () {
            $('prepare').fadein();
            sounds.playGameMusic();
        },
        onleavepreparing: function () {
            $('prepare').fadeout();
        },
    ...
    var Sounds = Class.create({
        ...
        isMute: function () {
            return to.bool(engine.storage.mute);
        },
        isNotMute: function () {
            return !this.isMute();
        },
        ...
        playTitleMusic: function () {
            this.stopAllMusic();
            this.play(this.sounds.title);
        },
        playGameMusic: function () {
            this.stopAllMusic();
            this.play(this.sounds.game);
        },
        ...
        explode: function () {
            this.play(this.sounds.explode);
        },
        shoot: function () {
            this.play(this.sounds.shoot);
        }
